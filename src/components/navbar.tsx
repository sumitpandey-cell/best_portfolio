...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 lg:px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="glass-dark border border-white/20 text-white px-6 py-2 rounded-lg hover:bg-white/10 hover:scale-105 transition-all duration-300 font-medium text-sm tracking-wide glow relative overflow-hidden group">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-27 right-5 z-40 md:hidden transition-all duration-500 ${
          isMenuOpen
      ...
      >
        ...
        <div
          ref={menuRef}
          className={`w-72 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl transition-all duration-500 ${
        ...
        >
          <div className="flex flex-col items-center py-6 px-5 space-y-5">
            ...
            <button className="glass-dark border border-white/20 text-white px-6 py-2.5 rounded-lg hover:bg-white/10 hover:scale-105 transition-all duration-300 font-bold text-base tracking-wide glow relative overflow-hidden group w-full">
              <span className="relative z-10">HIRE ME</span>
              <span className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
            </button>
